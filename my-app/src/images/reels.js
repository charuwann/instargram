...
function Reels({width=12, height=12, boxBtm=24, boxLeft=24, color="rgb(142, 142, 142)", ...props}) {
  return (
    <svg 
    style={{...props}}
    aria-label="Reels" 
