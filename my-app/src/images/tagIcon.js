...
function Tag({boxBtm=24, boxLeft=24, viewBox="0 0 24 24", ...props}) {
  return (  
    <svg style={{...props}} viewBox={viewBox} aria-label="" class="_ab6-" color="rgb(142, 142, 142)" fill="rgb(142, 142, 142)" role="img" >
